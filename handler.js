...
export async function deleteUpdate(message) {
    try {
        ...
        this.reply(msg.chat, `
تم اكتشاف أن @${participant.split`@`[0]} قام بحذف رسالة.

لا تقلق، لقد قمنا بتوثيقها للاجيال القادمة! 😹`, msg)
...
global.dfail = (type, m, conn) => {
    let msg = {
        rowner: '*للمطور فقط* • هذا الأمر مخصص لمطور البوت فقط',
        owner: '*للمالِك فقط* • هذا الأمر مخصص لمالِك البوت فقط',
        mods: '*للمشرفين فقط* • هذا الأمر مخصص لمشرفي البوت فقط',
        premium: '*للمستخدمين المميزين فقط* • هذا الأمر مخصص للمستخدمين المميزين فقط',
        group: '*خاص بالمجموعات* • يمكن استخدام هذا الأمر داخل المجموعات فقط',
        private: '*خاص بالدردشة الخاصة* • يمكن استخدام هذا الأمر في الخاص فقط',
        admin: '*للمسؤولين فقط* • هذا الأمر مخصص لمسؤولي المجموعة فقط',
        botAdmin: '*البوت ليس مسؤولاً* • يمكن استخدام هذا الأمر فقط عندما يكون البوت مسؤولاً في المجموعة',
        unreg: '*لم تسجل بعد* • اكتب .تسجيل لاستخدام هذه الميزة',
        restrict: '*وضع التقييد غير مفعل* • ميزة التقييد غير مفعّلة في هذه الدردشة',
    }[type]
